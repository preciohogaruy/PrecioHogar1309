      ...
      <section className="pt-32 pb-8 bg-gray-50">
        <div className="container mx-auto px-6">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <Link href="/productos" className="hover:text-primary transition-colors duration-300">
              Productos
            </Link>
            <span>/</span>
            ...
            <div className="space-y-8">
              <div>
                <div className="flex items-center gap-4 mb-4">
                  <span className="text-sm text-secondary font-medium uppercase tracking-wide bg-blue-50 px-3 py-1 rounded-full">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button
                    variant="outline"
                    className="border-orange-200 text-primary hover:bg-orange-50 py-4 bg-transparent"
                  >
                ...
                <div className="space-y-6">
                  ...
                  <div className="mt-8 p-6 bg-orange-50 rounded-xl">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="font-medium text-orange-800">SKU: {product.productId}</span>
                    </div>
